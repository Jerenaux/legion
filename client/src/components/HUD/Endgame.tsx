        ...
        <div className="endgame_rewards_container">
          <div className="endgame_rewards_heading_container">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" height="24" width="24">
              <path
                d="M18.353 10.252L6.471 3.65c-1.323-.736-1.985-1.103-2.478-.813S3.5 3.884 3.5 5.398V18.6c0 1.514 0 2.271.493 2.561s1.155-.077 2.478-.813l11.882-6.6c1.392-.774 2.088-1.16 2.088-1.749 0-.588-.696-.975-2.088-1.748z"
                fill="#FFA600"
              />
            </svg>
        ...
        <div className="endgame_buttons">
          {showPlayAgain &&
            (this.context.getCompletedGames() > 11 ? (
              <div className="endgame_button endgame_button_primary" onClick={this.handlePlayAgain}>
          ...
          <div className="endgame_button endgame_button_secondary" onClick={this.props.closeGame}>
            <span>Main Menu</span>
          </div>
        </div>

        {!!this.state.selectedChest && (
          <OpenedChest
            width={width}
            height={height}
