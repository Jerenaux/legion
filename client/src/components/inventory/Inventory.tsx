...
class Inventory extends Component<InventoryProps> {
  ...
  handleConfirmPurchase = async () => {
    ...
    try {
      ...
      successToast(
        `Successfully purchased ${this.state.slotsQuantity} inventory slot${this.state.slotsQuantity > 1 ? "s" : ""}!`,
      );
        ...
        <div className="inventory-section">
          ...
          <div className="section-items">
            {inventory.map((itemId: number, i: number) => {
              ...
              return (
                <div key={i} className="item" style={slotStyle} data-item-icon={`${type}-${item?.id}`}>
                  <ItemIcon
                    action={item}
                    index={i}
                    hideHotKey={true}
        ...
        <div className="inventoryContainer">
          <div className="inventoryCategoryContainer">
            ...
            <div className="inventoryCategories">
              {(() => {
                console.log(
                  "Rendering inventory categories. Feature accessible:",
          ...
          <div className="inventoryWrapper">
            {!this.context.player.isLoaded ? (
              ...
              <div className="inventory-sections">
                ...
                {!Object.values(InventoryType).some((type) => this.context.player.inventory[type]?.length > 0) && (
                  <div className="empty-slots-container">
                    ...
                    {this.context.canAccessFeature(LockedFeatures.CONSUMABLES_BATCH_1) && (
                      <Link href="/shop">
                        Go to shop <img src={shopIcon} alt="shop" />
                      </Link>
                    )}
                  </div>
                )}
          ...
          <div className="purchase-dialog-container">
            ...
            <div className="purchase-dialog-content">
              ...
              <div className="price-display">
                ...
                <div className="remaining-gold">
                  ...
                  <span
                    className={`price-value ${(this.context.player.gold - this.state.slotsQuantity * INVENTORY_SLOT_PRICE) < 0 ? "insufficient" : ""}`}
                  >
                    <img src={goldIcon} alt="gold" className="gold-icon" />
            ...
            <div className="purchase-dialog-buttons">
              {this.state.isPurchasing ? (
                ...
                <>
                  <button className="purchase-dialog-cancel" onClick={this.handleClosePurchaseDialog}>
        ...
        <Modal isOpen={this.state.openModal} onRequestClose={this.handleCloseModal}>
          <div className="hint-modal-container">
            ...
            <div className="hint-modal-button-container">
              <button className="hint-modal-decline" onClick={this.handleCloseModal}>
                Close
              </button>
            </div>
          </div>
