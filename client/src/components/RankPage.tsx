...
const rankNoImage = [goldRankNo, silverRankNo, bronzeRankNo];

export const rankIcons = [bronzeRankIcon, silverRankIcon, goldRankIcon, zenithRankIcon, apexRankIcon, alltimeRankIcon];
