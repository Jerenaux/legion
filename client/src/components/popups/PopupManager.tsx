...
const POPUP_CONFIGS: Record<Popup, PopupConfig> = {
  ...
  [Popup.PlayTwiceToUnlockShop]: {
    ...
    priority: 1,
    highlightSelectors: ['[data-playmode="practice"]', '[data-playmode="casual"]'],
    props: {
  ...
  [Popup.UnlockedShop]: {
    ...
    props: {
      name: "The shop",
      description:
        'You can now buy <span class="highlight-text">Consumables</span> for your characters in the <span class="highlight-text">Shop</span>! Here\'s some gold and potions to get you started.',
      rewards: UNLOCK_REWARDS[LockedFeatures.CONSUMABLES_BATCH_1],
      route: "/shop",
    },
  },
  ...
  [Popup.UnlockedSpells]: {
    ...
    props: {
      ...
      description:
        'You can now buy <span class="highlight-text">Spells</span> for your mages from the shop! Here is some gold, and some <span class="highlight-text">Ethers</span> to replenish <span class="highlight-text">MP</span> after casting spells.',
  ...
  [Popup.UnlockedEquipment]: {
    ...
    props: {
      ...
      description:
        'You can now buy <span class="highlight-text">Equipment</span> for your characters from the shop! Here is some gold, and a <span class="highlight-text">Golden Ring</span> to start your collection!',
  ...
  [Popup.UnlockedRanked]: {
    ...
    props: {
      name: "Ranked Mode",
      description:
        'You can now compete against other players in <span class="highlight-text">Ranked Mode</span> for the top spot on the leaderboard! Here is some more gold, and two <span class="highlight-text">Clovers</span> to help you a bit!',
  ...
  [Popup.UnlockedDailyLoot]: {
    ...
    props: {
      name: "Daily Rewards",
      description:
        'From now on, you can get a daily rewards, every 6, 12 and 24 hours! Play <span class="highlight-text">Casual</span> or <span class="highlight-text">Ranked</span> games to get keys to open the chests!',
  ...
  [Popup.UnlockedCharacters]: {
    ...
    props: {
      name: "Characters",
      description:
        'You can now increase your team size by purchasing additional <span class="highlight-text">Characters</span> in the shop!',
  ...
  [Popup.PlayToUnlockConsumables2]: {
    ...
    highlightSelectors: ['[data-playmode="casual"]', '[data-playmode="ranked"]'],
  },
...
export class PopupManager extends Component<Props, State> {
  ...
  resolvePopup = () => {
    ...
    const nextPopup = Array.from(queuedPopups).reduce(
      (highest, current) => {
  ...
  render() {
    ...
    return <PopupComponent onHide={this.handlePopupClosed} {...config.props} />;
  }
}
