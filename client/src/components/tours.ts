...
function startPlayTour() {
  ...
  tour.addStep(
    step(
      tour,
      "This is the Play Page of your Player Dashboard! From here you can launch games and claim your daily loot!",
      null,
    ),
  );
  tour.addStep(
    step(tour, "Use these flags to navigate between the different menus of the Player Dashboard!", {
      element: ".menuItems",
      on: "bottom",
    }),
  );
  tour.addStep(
    step(tour, "These are your gold and your rank in your current league!", {
      element: "#goldEloArea",
      on: "bottom",
    }),
  );
  tour.addStep(
    step(tour, "These are you characters, you can click on them to manage their stats and equipment!", {
      element: ".rosterContainer",
      on: "top",
    }),
  );
  tour.addStep(
    step(tour, "These 3 buttons allow you to start a game of your choice anytime you want!", {
...
function startTeamTour() {
  ...
  tour.addStep(
    step(
      tour,
      "This is the Team Page. From here you can manage your inventory and your characters' equipment, spells and stats!",
      null,
    ),
  );
  tour.addStep(
  ...
  tour.addStep(
    step(tour, "Use these tabs to navigate between the different types of items in your inventory!", {
...
function startShopTour() {
  ...
  tour.addStep(
    step(
      tour,
      "This is the Shop Page. Here you can buy consumables, equipment, spells and even new characters to expand your team!",
      null,
    ),
  );
  tour.addStep(
  ...
  tour.addStep(
    step(tour, "These icons indicate the effects of items, the duration of the cooldown and the type of target.", {
      element: ".consumable-card-effect-container",
      on: "right",
    }),
  );
  tour.addStep(
    step(tour, "This is how much of that item you already own!", {
...
function startRankTour() {
  ...
  tour.addStep(
    step(
      tour,
      "This is the Rank Page. Here you can check your ranking in your league's leaderboard or the all-time leaderboard and check out the top players of each league!",
      null,
    ),
  );
  tour.addStep(
